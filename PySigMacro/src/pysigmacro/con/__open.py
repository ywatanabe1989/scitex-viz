#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# Timestamp: "2025-04-01 13:58:08 (ywatanabe)"
...
def open(lpath=None, close_others=False, visible=True):
    ...
    try:
        ...
        # # Create the COM object first so we can set visibility before opening file
        ...
        if lpath:
            ...
            def check_notebook_loaded():
                try:
                    ...
                    sp = win32com.client.Dispatch("SigmaPlot.Application")
                    spw = wrap(sp, "SigmaPlot")
                    spw.Visible = visible  # Ensure visibility is set correctly
